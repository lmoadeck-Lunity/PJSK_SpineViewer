  ...
  const getAssetPaths = useCallback((chibiValue: string) => {
    ...
    if (isV2) {
      return {
        ...
        atlasUrl: `/Files/out/${chibiValue}/sekai_atlas/sekai_atlas.atlas.txt`,
        skeletonType: 'json' as const
      };
    } else {
      return {
        skeletonUrl: '/Files/skeleton/sd_main.skel',
        atlasUrl: `/Files/out/${chibiValue}/sekai_atlas/sekai_atlas.atlas`,
      ...
      class SpineApp {
        ...
        initialize(canvas: any) {
          try {
            ...
            // CRITICAL: Set the skin to "default" - this is likely what's causing the atlas texture issue!
